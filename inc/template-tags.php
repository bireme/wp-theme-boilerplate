...
if ( ! function_exists( 'wp_theme_boilerplate_posted_by' ) ) :
	/**
	 * Prints HTML with meta information for the current author.
	 */
	function wp_theme_boilerplate_posted_by() {
		$byline = sprintf(
...
if ( ! function_exists( 'wp_theme_boilerplate_post_thumbnail' ) ) :
	/**
	 ...
	 */
	function wp_theme_boilerplate_post_thumbnail() {
